...
的预览效果:
\begin{center}
    \includegraphics[scale=0.6]{./images/page46-1.png}
\end{center}

如果把它应用到一个拼写错误的单词上, 得到的就是:
\begin{center}
    \includegraphics[scale=0.6]{./images/page46-2.png}
\end{center}
...
\begin{center}
    \begin{tabular}{ll}
        ...
        \texttt{<Left>}   & 方向键, 左 \\
        \texttt{<Right>}   & 方向键, 右 \\
        \texttt{<F1>} - \texttt{<F12>}  & 功能键, \texttt{F1} 到 \texttt{F12}
...
相反, 如果在 1 秒之内用户按下了 \key{1}, Vim 就会执行 \texttt{MyFunction1}
的功能.
